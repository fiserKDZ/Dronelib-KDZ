...
from core.regulator import PidRegulator
...
FORWARD_CHR = curses.KEY_UP
BACKWARD_CHR = curses.KEY_DOWN
LEFT_CHR = curses.KEY_LEFT
RIGHT_CHR = curses.KEY_RIGHT
LEFTYAW_CHR = ord('a')
RIGHTYAW_CHR = ord('d')
UPWARD_CHR = ord('w') #curses.KEY_PPAGE
DOWNWARD_CHR = ord('s') #curses.KEY_NPAGE
PAUSE_CHR = ord('p')
ARM_CHR = ord('q')
DISARM_CHR = ord('e')
REBOOT_CHR = ord('r')
...
DEFAULT_AUX2 = 1000  # Angle (1000) / NAV_ALTHOLD (1500) / NAV_POSHOLD (1800)
DEFAULT_AUX3 = 1000
DEFAULT_AUX4 = 1000
    ...
    def run_curses(self):
        ...
        try:
            ...
            if self.print_screen:
                screen.addstr(1, 0, "Press 'q' to ARM, 'e' to DISARM, 'r' to EXIT, 'WASD + ARROWS' to controll the drone manually, 't' to TAKEOFF, 'l' to LAND, 'f' to start autonomous flight ", curses.A_BOLD)
