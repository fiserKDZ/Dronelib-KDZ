...
(function(root, factory) {
    ...
    Blockly.Python.init = function(a) {
        ...
        for (var b = [], c = Blockly.Variables.allDeveloperVariables(a), d = 0; d < c.length; d++) b.push(this.nameDB_.getName(c[d], Blockly.Names.DEVELOPER_VARIABLE_TYPE) + " = None");
        a = Blockly.Variables.allUsedVarModels(a);
        for (d = 0; d < a.length; d++) b.push(this.nameDB_.getName(a[d].getId(), Blockly.VARIABLE_CATEGORY_NAME) + " = None");
    ...
    Blockly.Python.lists_setIndex = function(a) {
        ...
        switch (d) {
            ...
            case "RANDOM":
                Blockly.Python.definitions_.import_random = "import random";
                b.match(/^\w+$/) ? a = "" : (a = Blockly.Python.nameDB_.getDistinctName("tmp_list", Blockly.VARIABLE_CATEGORY_NAME), d = a + " = " + b + "\n", b = a, a = d);
                d = Blockly.Python.nameDB_.getDistinctName("tmp_x",
    ...
    Blockly.Python.controls_repeat_ext = function(a) {
        ...
        return "for " + Blockly.Python.nameDB_.getDistinctName("count", Blockly.VARIABLE_CATEGORY_NAME) + " in range(" + b + "):\n" + c
    };
    ...
    Blockly.Python.controls_for = function(a) {
        var b = Blockly.Python.nameDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME),
        ...
        if (Blockly.isNumber(c) && Blockly.isNumber(d) &&
            Blockly.isNumber(e)) c = Number(c), d = Number(d), e = Math.abs(Number(e)), 0 === c % 1 && 0 === d % 1 && 0 === e % 1 ? (c <= d ? (d++, a = 0 == c && 1 == e ? d : c + ", " + d, 1 != e && (a += ", " + e)) : (d--, a = c + ", " + d + ", -" + e), a = "range(" + a + ")") : (a = c < d ? k() : h(), a += "(" + c + ", " + d + ", " + e + ")");
        else {
            var m = function(g, l) {
                Blockly.isNumber(g) ? g = Number(g) : g.match(/^\w+$/) ? g = "float(" + g + ")" : (l = Blockly.Python.nameDB_.getDistinctName(b + l, Blockly.VARIABLE_CATEGORY_NAME), n += l + " = float(" + g + ")\n", g = l);
                return g
            };
            c = m(c, "_start");
            d = m(d, "_end");
            e = m(e, "_inc");
            "number" == typeof c &&
                "number" == typeof d ? (a = c < d ? k() : h(), a += "(" + c + ", " + d + ", " + e + ")") : a = a(c, d, e)
        }
        return n += "for " + b + " in " + a + ":\n" + f
    };
    ...
    Blockly.Python.math_change = function(a) {
        ...
        a = Blockly.Python.nameDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME);
    ...
    Blockly.Python.procedures_defreturn = function(a) {
        for (var b = [], c = a.workspace, d = Blockly.Variables.allUsedVarModels(c) || [], e = 0, f; f = d[e]; e++) f = f.name, -1 == a.getVars().indexOf(f) && b.push(Blockly.Python.nameDB_.getName(f, Blockly.VARIABLE_CATEGORY_NAME));
        d = Blockly.Variables.allDeveloperVariables(c);
        for (e = 0; e < d.length; e++) b.push(Blockly.Python.nameDB_.getName(d[e], Blockly.Names.DEVELOPER_VARIABLE_TYPE));
        ...
        f = "";
        Blockly.Python.STATEMENT_PREFIX && (f += Blockly.Python.injectId(Blockly.Python.STATEMENT_PREFIX, a));
        Blockly.Python.STATEMENT_SUFFIX && (f += Blockly.Python.injectId(Blockly.Python.STATEMENT_SUFFIX, a));
        f && (f = Blockly.Python.prefixLines(f, Blockly.Python.INDENT));
        var n = "";
        ...
        var k = Blockly.Python.statementToCode(a, "STACK"),
            h = Blockly.Python.valueToCode(a, "RETURN",
        ...
        var g = [];
        d = a.getVars();
        for (e = 0; e < d.length; e++) g[e] = Blockly.Python.nameDB_.getName(d[e], Blockly.VARIABLE_CATEGORY_NAME);
        b = "def " + c + "(" + g.join(", ") + "):\n" + b + f + n + k + m + h;
    ...
    Blockly.Python.procedures_callreturn = function(a) {
        for (var b = Blockly.Python.nameDB_.getName(a.getFieldValue("NAME"), Blockly.PROCEDURE_CATEGORY_NAME), c = [], d = a.getVars(), e = 0; e < d.length; e++) c[e] = Blockly.Python.valueToCode(a, "ARG" + e, Blockly.Python.ORDER_NONE) || "None";
    ...
    Blockly.Python.text_join = function(a) {
        switch (a.itemCount_) {
            ...
            default:
                ...
                a = Blockly.Python.nameDB_.getDistinctName("x", Blockly.VARIABLE_CATEGORY_NAME);
    ...
    Blockly.Python.variables_get = function(a) {
        return [Blockly.Python.nameDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME), Blockly.Python.ORDER_ATOMIC]
    };
    Blockly.Python.variables_set = function(a) {
        var b = Blockly.Python.valueToCode(a, "VALUE", Blockly.Python.ORDER_NONE) || "0";
        return Blockly.Python.nameDB_.getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME) + " = " + b + "\n"
    };
